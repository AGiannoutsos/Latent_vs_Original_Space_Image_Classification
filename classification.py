...
# inport our files
from autoencoder.model import get_Classifier, train_Classifier
from autoencoder.visualization import classifier_prediction_visualization_window, classifier_loss_visualization_window, classifier_prediction_visualization
...
def main():
    ...
    # ask if want to get the output only of a model
    validInput = False
    while not validInput:
    ...
    if answer == 'y' or answer == 'Y':
        ...
        # get a list of indexes for each cluster
        clusters_lists = []
